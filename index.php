    ...
    <div class="container">
      <form class="form-login" action="login.php" method="POST">
        ...
        <div class="login-wrap">
          <input type="text" class="form-control" name="login" value="<?php if (isset($_COOKIE['login']) && !empty($_COOKIE['login'])) {
                                                                        echo $_COOKIE['login'];
                                                                      } ?>" placeholder="User ID" autofocus>
          <br>
          <input type="password" class="form-control" value="<?php if (isset($_COOKIE['password']) && !empty($_COOKIE['login'])) {
