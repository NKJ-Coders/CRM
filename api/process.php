...
function bookCalendar() {
	...
	*/
	...
	$requete = $bdd->prepare("INSERT INTO rendez_vous(IDCOM, IDCONT, OBJETRDV, DESCRIPTIONRDV, DATERDV, LIEURDV, statut, online) values(:idcom,:idcont,:objet,:descriptionrdv,:daterdv,:lieu,:statut,:onlinerdv)");
